To make storage-\/plugins suitable for {\ttfamily spec} they need to be able to store all the metadata as specified in \href{/home/jenkins/workspace/libelektra-release-pipeline-testing/doc/METADATA.ini}{\tt M\+E\+T\+A\+D\+A\+T\+A.\+ini}. Most file formats do not have support for that.
