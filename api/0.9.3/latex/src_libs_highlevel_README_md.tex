...
You can find the complete list of the available functions for all supported value types in \href{/home/jenkins/workspace/libelektra-release-pipeline-testing/src/include/elektra.h}{\tt elektra.\+h}
