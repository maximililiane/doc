...
This assumes you compiled the file \href{/home/jenkins/workspace/libelektra-release-pipeline-testing/src/plugins/specload/testapp.c}{\tt {\ttfamily testapp.\+c}} and it is available as the executable {\ttfamily testapp} in the current folder.
