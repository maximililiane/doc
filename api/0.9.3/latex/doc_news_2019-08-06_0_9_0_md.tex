...
\begin{DoxyItemize}
\item We fixed compiler warnings reported by G\+CC 9 in the \href{/home/jenkins/workspace/libelektra-release-pipeline-testing/src/plugins/mini/testmod_mini.c}{\tt unit test code} of the plugin. \+\_\+(René Schwaiger)\+\_\+
\end{DoxyItemize}
...
\item Added L\+C\+Dproc and \href{/home/jenkins/workspace/libelektra-release-pipeline-testing/examples/spec/cassandra.ini}{\tt Cassandra} specification examples. These examples provide a good guideline for writing specifications for configurations. \+\_\+(\+Michael Zronek)\+\_\+
