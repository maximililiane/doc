...
For this tutorial we decided to profile the ../../src/plugins/yajl/\+R\+E\+A\+D\+ME.md \char`\"{}\+Y\+A\+J\+L\char`\"{} plugin. Since Elektra loads plugin code via {\ttfamily dlopen} and Callgrind \href{https://stackoverflow.com/questions/16719395}{\tt does not support the function {\ttfamily dlclose} properly} we remove the {\ttfamily dlclose} calls in the file \href{/home/jenkins/workspace/libelektra-release-pipeline-testing/src/libs/loader/dl.c}{\tt {\ttfamily dl.\+c}} temporarily. At the time of writing one option to do that is deleting
