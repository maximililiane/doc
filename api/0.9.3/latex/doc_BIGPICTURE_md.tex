...
In file systems metadata describes information about files, e.\+g. when they were last accessed and who they are owned by ({\ttfamily ls -\/l}). In the same way Elektra has metadata that describe individual key-\/value pairs. In Elektra metadata is \href{/home/jenkins/workspace/libelektra-release-pipeline-testing/doc/METADATA.ini}{\tt defined globally} but implemented in many \hyperlink{src_plugins_README_md}{plugins}.
