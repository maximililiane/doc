...
The elements must be arranged in an array and each element must have a unique name, to identify the elements. The source can be found in \href{/home/jenkins/workspace/libelektra-release-pipeline-testing/src/include/kdbopmphm.h}{\tt kdbopmphm.\+h} and \href{/home/jenkins/workspace/libelektra-release-pipeline-testing/src/libs/elektra/opmphm.c}{\tt opmphm.\+c} and also works outside of Elektra.
