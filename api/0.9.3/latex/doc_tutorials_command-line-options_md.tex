...
You can find a full working example \href{/home/jenkins/workspace/libelektra-release-pipeline-testing/examples/opts.c}{\tt here}. However, it uses a hard coded specification which is a bit harder to read. 